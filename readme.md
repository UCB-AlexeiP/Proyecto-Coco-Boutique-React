...
- El número de WhatsApp y usuarios de Instagram/TikTok de la tienda se configuran al inicio de `src/pages/CatalogoPage.jsx`.
- La sesión se guarda en `localStorage`; si el token expira o es inválido, la app redirige automáticamente al login.